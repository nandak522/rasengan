# Django settings for Rasengan project.
import os
...
MEDIA_ROOT = os.path.join(PROJECT_DIRECTORY_PATH, 'site_media')
...
SECRET_KEY = '0g)-0_0_beqqnehb1+9qt$0^6ryq3+got0(fho_nvu6@1e0@oy'
...
WSGI_APPLICATION = '.'.join((PROJECT_NAME, 'wsgi', 'application'))
